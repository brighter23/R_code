...
#基础版：
plan20_0=run(all_data,path,0);plan20_0[[3]]
#反一反之后：
plan20_1=run(all_data,path,1);plan20_1[[3]]
# 使用新的反一反策略：25-1
plan20_2=run(all_data,path,2);plan20_2[[3]]

# 使用新的反一反策略 27-2：
plan20_3=run(all_data,path,3);plan20_3[[3]]
