...
new_quantize=function(path,set,Inverse){
  # 分BP的path有6列：
  if(Inverse)real_comb=true_path1(set)# 逆序的量化：连续的方式
...
run=function(data=data,path=path,inverse=T,choice=1019,rolling=F){
  library(stringr)
  n_path=nrow(path)
...
plan1019=run(data = all_data,path = path_BP,choice=1019,rolling=T)
present(plan1019)
plan1019_1=run(data = all_data,path = path_BP,choice=10191,rolling=T)
present(plan1019_1)
plan1019_2=run(data = all_data,path = path_BP,choice=10192,rolling=T)
present(plan1019_2)
plan1019_3=run(data = all_data,path = path_BP,choice=10193,rolling=T)
present(plan1019_3)
plan1019_4=run(data = all_data,path = path_BP,choice=10194,rolling=T)
present(plan1019_4)
plan1019_5=run(data = all_data,path = path_BP,choice=10195,rolling=T)
present(plan1019_5)
plan1019_6=run(data = all_data,path = path_BP,choice=10196,rolling=T)
present(plan1019_6)
plan1019_7=run(data = all_data,path = path_BP,choice=10197,rolling=T)
present(plan1019_7)
plan1019_8=run(data = all_data,path = path_BP,choice=10198,rolling=T)
present(plan1019_8)
plan1019_9=run(data = all_data,path = path_BP,choice=10199,rolling=T)
present(plan1019_9)
plan1019_10=run(data = all_data,path = path_BP,choice=101910,rolling=T)
present(plan1019_10)
plan1019_11=run(data = all_data,path = path_BP,choice=101911,rolling=T)
present(plan1019_11)
plan1019_12=run(data = all_data,path = path_BP,choice=101912,rolling=T)
present(plan1019_12)
plan1019_13=run(data = all_data,path = path_BP,choice=101913,rolling=T)
present(plan1019_13)
plan1019_20_1=run(data = all_data,path = path_BP,choice=1019201,rolling=T)
present(plan1019_20_1)
plan1019_20_2=run(data = all_data,path = path_BP,choice=1019202,rolling=T)
present(plan1019_20_2)

## 顺序===========================================================================
plan1019_11=run(data = all_data,path = path_BP,inverse = F,choice=101911,rolling=T)
present(plan1019_11)

plan1019_14=run(data = all_data,path = path_BP,inverse = F,choice=101914,rolling=T)
present(plan1019_14)
plan1019_15=run(data = all_data,path = path_BP,inverse = F,choice=101915,rolling=T)
present(plan1019_15)
