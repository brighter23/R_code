# 1、formula准备------------------------------------------
{
  ...
  AB5=cbind(A51,B52)
  BA5=cbind(B51,A52)
  path1=matrix(c(AB9,AB7,AB5, AB9,BA7,AB5, AB9,AB7,BA5, AB9,BA7,BA5, BA9,AB7,AB5, BA9,BA7,AB5, BA9,AB7,BA5, BA9,BA7,BA5),byrow = T,ncol = 6)
  colnames(path1)=c('B_R9','P_R9','B_R7','P_R7','B_R5','P_R5')
  minus_path1=matrix(c(BA9,BA7,BA5, BA9,AB7,BA5, BA9,BA7,AB5, BA9,AB7,AB5, AB9,BA7,BA5, AB9,AB7,BA5, AB9,BA7,AB5, AB9,AB7,AB5),byrow = T,ncol = 6)
  colnames(minus_path1)=c('B_R9','P_R9','B_R7','P_R7','B_R5','P_R5')}

# 新的formula在plan3下的表现：532-4
res5=run(data=all_data,path=path1,minus_path=minus_path1,seq = c(1,1,2))
res5=run(data=all_data,path=path1,minus_path=minus_path1,seq = c(0,1,2))
