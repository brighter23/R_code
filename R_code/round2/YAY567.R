...
{
  library(stringr)
  formula=read.csv2('data\\YAY567formula.csv',header = F,stringsAsFactors = F)
  formula1=read.csv2('data\\66R.csv',header = F,stringsAsFactors = F)
  
  R5A=formula[2:7,];R5B=formula[9:14,]
  R6A=formula[16:31,];R6B=formula[33:48,]
  R66A=formula1[2:17,];R66B=formula1[19:34,]
  R7A=formula[50:81,];R7B=formula[83:114,]
  R7A[13]="20,21,22,32,42,52,02,03,04,14,24,25"
  R7B[13]="20,21,22,32,42,43,02,03,04,14,24,34"
  ...
  R6A=Formula(R6A,c1 = 1:5,c2=6:10);R6B=Formula(R6B,c1 = 1:5,c2=6:10)
  ...
  path_BP66=matrix(c(R5A,R66A,R7A, R5A,R66B,R7A, R5A,R66A,R7B, R5A,R66B,R7B, R5B,R66A,R7A, R5B,R66B,R7A, R5B,R66A,R7B, R5B,R66B,R7B),byrow = T,ncol = 6)
  colnames(path_BP66)=c('B_R5','P_R5','B_R6','P_R6','B_R7','P_R7')
  
}

c=c('data','all_data','path_BP','path_BP66')
a=ls()
rm(list=(setdiff(a,c)))
gc()
library(stringr)
...
true_path0=function(dataset){
  ...
  comb1=paste0(result12,'-',result13,'-',result14,'-',result15,'-',result16,'-',result17)
  #6R
  t27=table(dataset[2:7])
  result27=paste0(t27[1],t27[2])
  t26=table(dataset[2:6])
  result26=paste0(t26[1],t26[2])
  t25=table(dataset[2:5])
  result25=paste0(t25[1],t25[2])
  t24=table(dataset[2:4])
  result24=paste0(t24[1],t24[2])
  t23=table(dataset[2:3])
  result23=paste0(t23[1],t23[2])
  comb2=paste0(result23,'-',result24,'-',result25,'-',result26,'-',result27)
  #5R
...
true_path1=function(dataset){
  ...
  comb1=paste0(result12,'-',result13,'-',result14,'-',result15,'-',result16,'-',result17)
  #6R
  t27=table(dataset[c(1:5,7)])
  result27=paste0(t27[1],t27[2])
  t26=table(dataset[1:5])
  result26=paste0(t26[1],t26[2])
  t25=table(dataset[1:4])
  result25=paste0(t25[1],t25[2])
  t24=table(dataset[1:3])
  result24=paste0(t24[1],t24[2])
  t23=table(dataset[1:2])
  result23=paste0(t23[1],t23[2])
  comb2=paste0(result23,'-',result24,'-',result25,'-',result26,'-',result27)
  #5R
...
new_quantize=function(path,set,Inverse){
  ...
  if(ncol(path)==6){
    ...
    for (j in 1:nrow(path)) {
      sparate_condition=ifelse(Inverse,set[1],set[2])
    ...
    r7=matrix(0,ncol = nrow(path),nrow = 1)
    for (j in 1:nrow(path)) {
      r7[1,j]=ifelse(str_detect(real_comb[1,1],path[j,'R7']),1,-1)
    }
    r6=matrix(0,ncol = nrow(path),nrow = 1)
    for (j in 1:nrow(path)) {
...
# new_quantize(path = path_BP,set=data[1:7,1],Inverse=T) # 测试应该是正负相对
# 2.3 定义诊断连续负的长度：
...
# 取数据：
{
  ...
  data_sort_thirteen_inverse=function(data=data,m,path=path){
    ...
    # 第一手：显+逆
    {
      ...
      for (i in seq(13,n,4)) {
        first_hand_quantity=new_quantize(path,set = data[c(seq(i-2,i-12,-2),i),m],Inverse=T)
    ...
    { 
      ...
      for (i in seq(14,n,4)) {
        second_hand_quantity=new_quantize(path,set = data[c(seq(i-2,i-12,-2),i),m],Inverse=T)
    ...
    # 第三手：显+逆
    {
      ...
      for (i in seq(15,n,4)) {
        third_hand_quantity=new_quantize(path,set = data[c(seq(i-2,i-12,-2),i),m],Inverse=T)
    ...
    { 
      ...
      for (i in seq(16,n,4)) {
        forth_hand_quantity=new_quantize(path,set = data[c(seq(i-2,i-12,-2),i),m],Inverse=T)
  ...
  data_sort_thirteen_inverse_cross=function(data=data,m,path=path){
    ...
    # 第一手：显+逆+奇偶交叉
    {
      first_hand=matrix(ncol = nrow(path))
      for (i in seq(13,n,4)) {
        first_hand_quantity=new_quantize(path,set = data[c(seq(i-1,i-11,-2),i),m],Inverse=T)
        first_hand=rbind(first_hand,first_hand_quantity)
      }
      first_hand=first_hand[-1,]
    }
    ...
    { 
      second_hand=matrix(ncol = nrow(path) )
      for (i in seq(14,n,4)) {
        second_hand_quantity=new_quantize(path,set = data[c(seq(i-3,i-13,-2),i),m],Inverse=T)
        second_hand=rbind(second_hand,second_hand_quantity)
      }
      second_hand=second_hand[-1,]
    }
    # 第三手：显+逆+奇偶交叉
    {
      third_hand=matrix(ncol = nrow(path))
      for (i in seq(15,n,4)) {
        third_hand_quantity=new_quantize(path,set = data[c(seq(i-1,i-11,-2),i),m],Inverse=T)
        third_hand=rbind(third_hand,third_hand_quantity)
      }
      third_hand=third_hand[-1,]
    }
    ...
    { 
      forth_hand=matrix(ncol = nrow(path) )
      for (i in seq(16,n,4)) {
        forth_hand_quantity=new_quantize(path,set = data[c(seq(i-3,i-13,-2),i),m],Inverse=T)
        forth_hand=rbind(forth_hand,forth_hand_quantity)
      }
      forth_hand=forth_hand[-1,]
    }
  ...
  data_sort_thirteen_inverse_refelection=function(data=data,m,path=path){
    ...
    # 第一手：re+逆
    {
      first_hand=matrix(ncol = nrow(path))
      for (i in seq(13,n,4)){
        first_hand_quantity=new_quantize(path,set = factor(c(reflection[seq(i-2,i-12,-2)],data[i,m]),levels=c(1,2)),Inverse=T)
        first_hand=rbind(first_hand,first_hand_quantity)
      }
      first_hand=first_hand[-1,]
    }
    # 第二手：re+逆
    {
      second_hand=matrix(ncol = nrow(path) )
      for (i in seq(14,n,4)) {
        second_hand_quantity=new_quantize(path,set = factor(c(reflection[seq(i-2,i-12,-2)],data[i,m]),levels=c(1,2)),Inverse=T)
        second_hand=rbind(second_hand,second_hand_quantity)
      }
      second_hand=second_hand[-1,]
    }
    # 第三手：re+逆
    {
      third_hand=matrix(ncol = nrow(path))
      for (i in seq(15,n,4)) {
        third_hand_quantity=new_quantize(path,set = factor(c(reflection[seq(i-2,i-12,-2)],data[i,m]),levels=c(1,2)),Inverse=T)
        third_hand=rbind(third_hand,third_hand_quantity)
      }
      third_hand=third_hand[-1,]
    }
    # 第四手：re+逆
    {
      forth_hand=matrix(ncol = nrow(path) )
      for (i in seq(16,n,4)) {
        forth_hand_quantity=new_quantize(path,set = factor(c(reflection[seq(i-2,i-12,-2)],data[i,m]),levels=c(1,2)),Inverse=T)
        forth_hand=rbind(forth_hand,forth_hand_quantity)
      }
      forth_hand=forth_hand[-1,]
    }
  ...
  data_sort_sequence_allsequence=function(data=data,m,path=path){
    ...
    # 第一手：顺
    {
      first_hand=matrix(ncol = nrow(path))
      for (i in seq(13,n,4)) {
        first_hand_quantity=new_quantize(path,set = data[c(seq(i-12,i-2,2),i),m],Inverse = F)
        first_hand=rbind(first_hand,first_hand_quantity)
      }
      first_hand=first_hand[-1,]
    }
    ...
    { 
      second_hand=matrix(ncol = nrow(path) )
      for (i in seq(14,n,4)) {
        second_hand_quantity=new_quantize(path,set = data[c(seq(i-12,i-2,2),i),m],Inverse = F)
        second_hand=rbind(second_hand,second_hand_quantity)
      }
      second_hand=second_hand[-1,]
    }
    # 第三手：顺
    {
      third_hand=matrix(ncol = nrow(path))
      for (i in seq(15,n,4)) {
        third_hand_quantity=new_quantize(path,set = data[c(seq(i-12,i-2,2),i),m],Inverse = F)
        third_hand=rbind(third_hand,third_hand_quantity)
      }
      third_hand=third_hand[-1,]
    }
    ...
    { 
      forth_hand=matrix(ncol = nrow(path) )
      for (i in seq(16,n,4)) {
        forth_hand_quantity=new_quantize(path,set = data[c(seq(i-12,i-2,2),i),m],Inverse = F)
        forth_hand=rbind(forth_hand,forth_hand_quantity)
      }
      forth_hand=forth_hand[-1,]
    }
  ...
  data_sort_sequence_allsequence_cross=function(data=data,m,path=path){
    ...
    # 第一手：显+顺+奇偶交叉
    {
      first_hand=matrix(ncol = nrow(path))
      for (i in seq(13,n,4)) {
        first_hand_quantity=new_quantize(path,set = data[c(seq(i-11,i-1,2),i),m],Inverse = F)
        first_hand=rbind(first_hand,first_hand_quantity)
      }
      first_hand=first_hand[-1,]
    }
    ...
    { 
      second_hand=matrix(ncol = nrow(path) )
      for (i in seq(14,n,4)) {
        second_hand_quantity=new_quantize(path,set = data[c(seq(i-13,i-3,2),i),m],Inverse = F)
        second_hand=rbind(second_hand,second_hand_quantity)
      }
      second_hand=second_hand[-1,]
    }
    # 第三手：显+顺+奇偶交叉
    {
      third_hand=matrix(ncol = nrow(path))
      for (i in seq(15,n,4)) {
        third_hand_quantity=new_quantize(path,set = data[c(seq(i-11,i-1,2),i),m],Inverse = F)
        third_hand=rbind(third_hand,third_hand_quantity)
      }
      third_hand=third_hand[-1,]
    }
    ...
    { 
      forth_hand=matrix(ncol = nrow(path) )
      for (i in seq(16,n,4)) {
        forth_hand_quantity=new_quantize(path,set = data[c(seq(i-13,i-3,2),i),m],Inverse = F)
        forth_hand=rbind(forth_hand,forth_hand_quantity)
      }
      forth_hand=forth_hand[-1,]
    }
...
# 顺+不交叉+显现==================================================
plan1019=run(data = all_data,path = path_BP,inverse = F,choice=1019,rolling=T,reflection=F,cross = F)
present(plan1019)
plan1019_1=run(data = all_data,path = path_BP,inverse = F,choice=10191,rolling=T,reflection=F,cross = F)
present(plan1019_1)
plan1019_2=run(data = all_data,path = path_BP,inverse = F,choice=10192,rolling=T,reflection=F,cross = F)
present(plan1019_2)
plan1019_3=run(data = all_data,path = path_BP,inverse = F,choice=10193,rolling=T,reflection=F,cross = F)
present(plan1019_3)
plan1019_4=run(data = all_data,path = path_BP,inverse = F,choice=10194,rolling=T,reflection=F,cross = F)
present(plan1019_4)
plan1019_5=run(data = all_data,path = path_BP,inverse = F,choice=10195,rolling=T,reflection=F,cross = F)
present(plan1019_5)
plan1019_6=run(data = all_data,path = path_BP,inverse = F,choice=10196,rolling=T,reflection=F,cross = F)
present(plan1019_6)
plan1019_7=run(data = all_data,path = path_BP,inverse = F,choice=10197,rolling=T,reflection=F,cross = F)
present(plan1019_7)
plan1019_8=run(data = all_data,path = path_BP,inverse = F,choice=10198,rolling=T,reflection=F,cross = F)
present(plan1019_8)
plan1019_9=run(data = all_data,path = path_BP,inverse = F,choice=10199,rolling=T,reflection=F,cross = F)
present(plan1019_9)
plan1019_10=run(data = all_data,path = path_BP,inverse = F,choice=101910,rolling=T,reflection=F,cross = F)
present(plan1019_10)
plan1019_11=run(data = all_data,path = path_BP,inverse = F,choice=101911,rolling=T,reflection=F,cross = F)
present(plan1019_11)
plan1019_12=run(data = all_data,path = path_BP,inverse = F,choice=101912,rolling=T,reflection=F,cross = F)
present(plan1019_12)
plan1019_13=run(data = all_data,path = path_BP,inverse = F,choice=101913,rolling=T,reflection=F,cross = F)
present(plan1019_13)
plan1019_14=run(data = all_data,path = path_BP,inverse = F,choice=101914,rolling=T,reflection=F,cross = F)
present(plan1019_14)
plan1019_15=run(data = all_data,path = path_BP,inverse = F,choice=101915,rolling=T,reflection=F,cross = F)
present(plan1019_15)
plan1019_20_1=run(data = all_data,path = path_BP,inverse = F,choice=1019201,rolling=T,reflection=F,cross = F)
present(plan1019_20_1)
plan1019_20_2=run(data = all_data,path = path_BP,inverse = F,choice=1019202,rolling=T,reflection=F,cross = F)
present(plan1019_20_2)
# 逆+不交叉+显现==============================================
plan1019_inverse=run(data = all_data,path = path_BP,inverse = T,choice=1019,rolling=T,reflection=F,cross = F)
present(plan1019_inverse)
plan1019_1_inverse=run(data = all_data,path = path_BP,inverse = T,choice=10191,rolling=T,reflection=F,cross = F)
present(plan1019_1_inverse)
plan1019_2_inverse=run(data = all_data,path = path_BP,inverse = T,choice=10192,rolling=T,reflection=F,cross = F)
present(plan1019_2_inverse)
plan1019_3_inverse=run(data = all_data,path = path_BP,inverse = T,choice=10193,rolling=T,reflection=F,cross = F)
present(plan1019_3_inverse)
plan1019_4_inverse=run(data = all_data,path = path_BP,inverse = T,choice=10194,rolling=T,reflection=F,cross = F)
present(plan1019_4_inverse)
plan1019_5_inverse=run(data = all_data,path = path_BP,inverse = T,choice=10195,rolling=T,reflection=F,cross = F)
present(plan1019_5_inverse)
plan1019_6_inverse=run(data = all_data,path = path_BP,inverse = T,choice=10196,rolling=T,reflection=F,cross = F)
present(plan1019_6_inverse)
plan1019_7_inverse=run(data = all_data,path = path_BP,inverse = T,choice=10197,rolling=T,reflection=F,cross = F)
present(plan1019_7_inverse)
plan1019_8_inverse=run(data = all_data,path = path_BP,inverse = T,choice=10198,rolling=T,reflection=F,cross = F)
present(plan1019_8_inverse)
plan1019_9_inverse=run(data = all_data,path = path_BP,inverse = T,choice=10199,rolling=T,reflection=F,cross = F)
present(plan1019_9_inverse)
plan1019_10_inverse=run(data = all_data,path = path_BP,inverse = T,choice=101910,rolling=T,reflection=F,cross = F)
present(plan1019_10_inverse)
plan1019_11_inverse=run(data = all_data,path = path_BP,inverse = T,choice=101911,rolling=T,reflection=F,cross = F)
present(plan1019_11_inverse)
plan1019_12_inverse=run(data = all_data,path = path_BP,inverse = T,choice=101912,rolling=T,reflection=F,cross = F)
present(plan1019_12_inverse)
plan1019_13_inverse=run(data = all_data,path = path_BP,inverse = T,choice=101913,rolling=T,reflection=F,cross = F)
present(plan1019_13_inverse)
plan1019_14_inverse=run(data = all_data,path = path_BP,inverse = T,choice=101914,rolling=T,reflection=F,cross = F)
present(plan1019_14_inverse)
plan1019_15_inverse=run(data = all_data,path = path_BP,inverse = T,choice=101915,rolling=T,reflection=F,cross = F)
present(plan1019_15_inverse)
plan1019_20_1_inverse=run(data = all_data,path = path_BP,inverse = T,choice=1019201,rolling=T,reflection=F,cross = F)
present(plan1019_20_1_inverse)
plan1019_20_2_inverse=run(data = all_data,path = path_BP,inverse = T,choice=1019202,rolling=T,reflection=F,cross = F)
present(plan1019_20_2_inverse)



# 逆+不交叉+reflection====================================
# 在20-1上就是与逆序的相反
plan1019_1_inverse_re=run(data = all_data,path = path_BP,inverse = T,choice=10191,rolling=T,reflection=T,cross = F)
present(plan1019_1_inverse_re)
plan1019_20_1_inverse_re=run(data = all_data,path = path_BP,inverse = T,choice=1019201,rolling=T,reflection=T,cross = F)
present(plan1019_20_1_inverse_re)
plan1019_20_2_inverse_re=run(data = all_data,path = path_BP,inverse = T,choice=1019202,rolling=T,reflection=T,cross = F)
present(plan1019_20_2_inverse_re)

# 顺+
# 顺+交叉+显现======================================
plan1019_cross=run(data = all_data,path = path_BP,inverse = F,choice=1019,rolling=T,reflection=F,cross = T)
present(plan1019_cross)
plan1019_1_cross=run(data = all_data,path = path_BP,inverse = F,choice=10191,rolling=T,reflection=F,cross = T)
present(plan1019_1_cross)
plan1019_2_cross=run(data = all_data,path = path_BP,inverse = F,choice=10192,rolling=T,reflection=F,cross = T)
present(plan1019_2_cross)
plan1019_11_cross=run(data = all_data,path = path_BP,inverse = F,choice=101911,rolling=T,reflection=F,cross = T)
present(plan1019_11_cross)
plan1019_20_1_cross=run(data = all_data,path = path_BP,inverse = F,choice=1019201,rolling=T,reflection=F,cross = T)
present(plan1019_20_1_cross)
# 逆+交叉+显现===================================
plan1019_inverse_cross=run(data = all_data,path = path_BP,inverse = T,choice=1019,rolling=T,reflection=F,cross = T)
present(plan1019_inverse_cross)
plan1019_1_inverse_cross=run(data = all_data,path = path_BP,inverse = T,choice=10191,rolling=T,reflection=F,cross = T)
present(plan1019_1_inverse_cross)
plan1019_2_inverse_cross=run(data = all_data,path = path_BP,inverse = T,choice=10192,rolling=T,reflection=F,cross = T)
present(plan1019_2_inverse_cross)
plan1019_11_inverse_cross=run(data = all_data,path = path_BP,inverse = T,choice=101911,rolling=T,reflection=F,cross = T)
present(plan1019_11_inverse_cross)
plan1019_20_1_inverse_cross=run(data = all_data,path = path_BP,inverse = T,choice=1019201,rolling=T,reflection=F,cross = T)
present(plan1019_20_1_inverse_cross)
# R66=========================================================
# 顺+不交叉+显现
plan1019_R66=run(data = all_data,path = path_BP66,inverse = F,choice=1019,rolling=T,reflection=F,cross = F)
present(plan1019_R66)
plan1019_1_R66=run(data = all_data,path = path_BP66,inverse = F,choice=10191,rolling=T,reflection=F,cross = F)
present(plan1019_1_R66)
plan1019_2_R66=run(data = all_data,path = path_BP66,inverse = F,choice=10192,rolling=T,reflection=F,cross = F)
present(plan1019_2_R66)
plan1019_11_R66=run(data = all_data,path = path_BP66,inverse = F,choice=101911,rolling=T,reflection=F,cross = F)
present(plan1019_11_R66)
plan1019_20_1_R66=run(data = all_data,path = path_BP66,inverse = F,choice=1019201,rolling=T,reflection=F,cross = F)
present(plan1019_20_1_R66)
# 逆+不交叉+显现
plan1019_inverse_R66=run(data = all_data,path = path_BP66,inverse = T,choice=1019,rolling=T,reflection=F,cross = F)
present(plan1019_inverse_R66)
plan1019_1_inverse_R66=run(data = all_data,path = path_BP66,inverse = T,choice=10191,rolling=T,reflection=F,cross = F)
present(plan1019_1_inverse_R66)
plan1019_2_inverse_R66=run(data = all_data,path = path_BP66,inverse = T,choice=10192,rolling=T,reflection=F,cross = F)
present(plan1019_2_inverse_R66)
plan1019_11_inverse_R66=run(data = all_data,path = path_BP66,inverse = T,choice=101911,rolling=T,reflection=F,cross = F)
present(plan1019_11_inverse_R66)
plan1019_20_1_inverse_R66=run(data = all_data,path = path_BP66,inverse = T,choice=1019201,rolling=T,reflection=F,cross = F)
present(plan1019_20_1_inverse_R66)
# 顺+交叉+显现
plan1019_cross_R66=run(data = all_data,path = path_BP66,inverse = F,choice=1019,rolling=T,reflection=F,cross = T)
present(plan1019_cross_R66)
plan1019_1_cross_R66=run(data = all_data,path = path_BP66,inverse = F,choice=10191,rolling=T,reflection=F,cross = T)
present(plan1019_1_cross_R66)
plan1019_2_cross_R66=run(data = all_data,path = path_BP66,inverse = F,choice=10192,rolling=T,reflection=F,cross = T)
present(plan1019_2_cross_R66)
plan1019_11_cross_R66=run(data = all_data,path = path_BP66,inverse = F,choice=101911,rolling=T,reflection=F,cross = T)
present(plan1019_11_cross_R66)
plan1019_20_1_cross_R66=run(data = all_data,path = path_BP66,inverse = F,choice=1019201,rolling=T,reflection=F,cross = T)
present(plan1019_20_1_cross_R66)
# 逆+交叉+显现
plan1019_inverse_cross_R66=run(data = all_data,path = path_BP66,inverse = T,choice=1019,rolling=T,reflection=F,cross = T)
present(plan1019_inverse_cross_R66)
plan1019_1_inverse_cross_R66=run(data = all_data,path = path_BP66,inverse = T,choice=10191,rolling=T,reflection=F,cross = T)
present(plan1019_1_inverse_cross_R66)
plan1019_2_inverse_cross_R66=run(data = all_data,path = path_BP66,inverse = T,choice=10192,rolling=T,reflection=F,cross = T)
present(plan1019_2_inverse_cross_R66)
plan1019_11_inverse_cross_R66=run(data = all_data,path = path_BP66,inverse = T,choice=101911,rolling=T,reflection=F,cross = T)
present(plan1019_11_inverse_cross_R66)
plan1019_20_1_inverse_cross_R66=run(data = all_data,path = path_BP66,inverse = T,choice=1019201,rolling=T,reflection=F,cross = T)
present(plan1019_20_1_inverse_cross_R66)


# plan1210-15~18====================================================================
# plan1210-15
# 顺序+不交叉：
plan1210_15_R66=run(data = all_data,path = path_BP66,inverse = F,choice=121015,rolling=T,reflection=F,cross = F)
present(plan1210_15_R66,index_c = F)
# 顺序+交叉：
plan1210_15_R66_cross=run(data = all_data,path = path_BP66,inverse = F,choice=121015,rolling=T,reflection=F,cross = T)
present(plan1210_15_R66_cross)
# 逆序+不交叉：
plan1210_15_R66_inverse=run(data = all_data,path = path_BP66,inverse = T,choice=121015,rolling=T,reflection=F,cross = F)
present(plan1210_15_R66_inverse)
# 逆序+交叉：
plan1210_15_R66_inverse_cross=run(data = all_data,path = path_BP66,inverse = T,choice=121015,rolling=T,reflection=F,cross = T)
present(plan1210_15_R66_inverse_cross)


# plan1210-16
# 顺序+不交叉：
plan1210_16_R66=run(data = all_data,path = path_BP66,inverse = F,choice=121016,rolling=T,reflection=F,cross = F)
present(plan1210_16_R66)
# 顺序+交叉：
plan1210_16_R66_cross=run(data = all_data,path = path_BP66,inverse = F,choice=121016,rolling=T,reflection=F,cross = T)
present(plan1210_16_R66_cross)
# 逆序+不交叉：
plan1210_16_R66_inverse=run(data = all_data,path = path_BP66,inverse = T,choice=121016,rolling=T,reflection=F,cross = F)
present(plan1210_16_R66_inverse)
# 逆序+交叉：
plan1210_16_R66_inverse_cross=run(data = all_data,path = path_BP66,inverse = T,choice=121016,rolling=T,reflection=F,cross = T)
present(plan1210_16_R66_inverse_cross)


# plan1210-17
# 顺序+不交叉：
plan1210_17_R66=run(data = all_data,path = path_BP66,inverse = F,choice=121017,rolling=T,reflection=F,cross = F)
present(plan1210_17_R66)
# 顺序+交叉：
plan1210_17_R66_cross=run(data = all_data,path = path_BP66,inverse = F,choice=121017,rolling=T,reflection=F,cross = T)
present(plan1210_17_R66_cross)
# 逆序+不交叉：
plan1210_17_R66_inverse=run(data = all_data,path = path_BP66,inverse = T,choice=121017,rolling=T,reflection=F,cross = F)
present(plan1210_17_R66_inverse)
# 逆序+交叉：
plan1210_17_R66_inverse_cross=run(data = all_data,path = path_BP66,inverse = T,choice=121017,rolling=T,reflection=F,cross = T)
present(plan1210_17_R66_inverse_cross)


# plan1210-18
# 顺序+不交叉：
plan1210_18_R66=run(data = all_data,path = path_BP66,inverse = F,choice=121018,rolling=T,reflection=F,cross = F)
present(plan1210_18_R66)
# 顺序+交叉：
plan1210_18_R66_cross=run(data = all_data,path = path_BP66,inverse = F,choice=121018,rolling=T,reflection=F,cross = T)
present(plan1210_18_R66_cross)
# 逆序+不交叉：
plan1210_18_R66_inverse=run(data = all_data,path = path_BP66,inverse = T,choice=121018,rolling=T,reflection=F,cross = F)
present(plan1210_18_R66_inverse)
# 逆序+交叉：
plan1210_18_R66_inverse_cross=run(data = all_data,path = path_BP66,inverse = T,choice=121018,rolling=T,reflection=F,cross = T)
present(plan1210_18_R66_inverse_cross)


# plan1211-1~4================================================
# R6
plan1211_1=run(data = all_data,path = path_BP,inverse = F,choice=12111,rolling=F,reflection=F,cross = F)
present(plan1211_1,index_c = F)
plan1211_2=run(data = all_data,path = path_BP,inverse = F,choice=12112,rolling=F,reflection=F,cross = F)
present(plan1211_2,index_c = F)
plan1211_3=run(data = all_data,path = path_BP,inverse = F,choice=12113,rolling=F,reflection=F,cross = F)
present(plan1211_3,index_c = F)
plan1211_4=run(data = all_data,path = path_BP,inverse = F,choice=12114,rolling=F,reflection=F,cross = F)
present(plan1211_4,index_c = F)
# R66
plan1211_1_R66=run(data = all_data,path = path_BP66,inverse = F,choice=12111,rolling=F,reflection=F,cross = F)
present(plan1211_1_R66,index_c = F)
plan1211_2_R66=run(data = all_data,path = path_BP66,inverse = F,choice=12112,rolling=F,reflection=F,cross = F)
present(plan1211_2_R66,index_c = F)
plan1211_3_R66=run(data = all_data,path = path_BP66,inverse = F,choice=12113,rolling=F,reflection=F,cross = F)
present(plan1211_3_R66,index_c = F)
plan1211_4_R66=run(data = all_data,path = path_BP66,inverse = F,choice=12114,rolling=F,reflection=F,cross = F)
present(plan1211_4_R66,index_c = F)
