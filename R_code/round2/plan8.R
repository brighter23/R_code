...
run=function(data=data,path=path,minus_path=minus_path,version="combine"){
  #注意这里的n
  n=nrow(data)
...
run(data=data,path=path,minus_path=minus_path,version = 'sparate')
run(data=data1,path=path,minus_path=minus_path,version = 'sparate')

# 3、预测---------------------------------------------
pred_unsatisfy_num=function(index,data=data,version="combine"){
...
unsatisfy_num1=pred_unsatisfy_num(index=4,data=data,version="sparate")
