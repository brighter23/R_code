...
plan21_0=run(data=all_data,path=path,seq=0);plan21_0[[3]]
plan21_1=run(data=all_data,path=path,seq=1);plan21_1[[3]]
plan21_2=run(data=all_data,path=path,seq=2);plan21_2[[3]]
plan21_3=run(data=all_data,path=path,seq=3);plan21_3[[3]]
