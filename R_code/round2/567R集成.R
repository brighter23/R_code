...
# 取数据：
{
  ...
  # “错误”的版本4：断开取数据的方式——从21手开始，1&2手改为顺序B
  ...
  # “错误”的版本4：断开取数据的方式——从13手开始，1&2手改为顺序B
  ...
  # “错误”的版本4：断开取数据的方式——从21手开始，12手逆序，34手顺序C
  ...
  # “错误”的版本4：断开取数据的方式——从13手开始，12手逆序，34手顺序C
  ...
  # plan2319 错误版本——从13手开始,1&3手改为顺序B
  ...
  # plan2319 错误版本——从21手,1&3为逆序，2&4为顺序C
  ...
  # plan2319 错误版本——从13手,1&3为逆序，2&4为顺序C
